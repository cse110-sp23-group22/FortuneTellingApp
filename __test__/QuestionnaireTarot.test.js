...
const dom = new JSDOM(
  '<!DOCTYPE html><div id="fname"></div><input id="creepyQuestion1"></input><input id="creepyQuestion2"></input><form id="form1"><input></input></form><button id="exitButton"></button><input id="myInput"></input><button id="homeButton" class="back"></button>'
);
